...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/app/camera/PlugInShootingModesLoader;->SHOOTING_MODES_INCLUDE_DELETED_URI:Landroid/net/Uri;
    ...
    const-string v1, "com.sec.android.app.camera.Fast Video"
...
.method public loadExternalShootingModes()Z
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/PlugInShootingModesLoader;->loadExternalShootingModes(Z)Z
...
.method public declared-synchronized loadExternalShootingModes(Z)Z
    .locals 22
    ...
    invoke-virtual {v2}, Lcom/sec/android/app/camera/Camera;->getPackageManager()Landroid/content/pm/PackageManager;
    :try_end_0
    ...
    sget-object v3, Lcom/sec/android/app/camera/PlugInShootingModesLoader;->SHOOTING_MODES_INCLUDE_DELETED_URI:Landroid/net/Uri;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/sec/android/app/camera/Camera;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {v6, v0, v1}, Lcom/sec/android/app/camera/PlugInShootingModesStorage;->setExternalModesIncludeDeleted(Landroid/content/Context;Landroid/util/SparseArray;)V
    :try_end_2
    ...
    .line 180
    const-string v2, "com.samsung.android.provider.shootingmodeprovider"
    ...
    invoke-virtual {v2, v0}, Lcom/sec/android/app/camera/Camera;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
    :try_end_5
    ...
    invoke-virtual {v6}, Lcom/sec/android/app/camera/Camera;->getApplicationContext()Landroid/content/Context;

    move-result-object v6

    move-object/from16 v0, v18

    invoke-virtual {v2, v6, v0}, Lcom/sec/android/app/camera/PlugInShootingModesStorage;->setExternalModesIncludeDeleted(Landroid/content/Context;Landroid/util/SparseArray;)V
    :try_end_6
